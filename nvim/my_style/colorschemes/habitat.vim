" Vim color file
" A version of habiLight.vim colorscheme

" vim: tw=0 ts=4 sw=4
" Maintainer:  Austin Rhodes
" Email:       warhodes@gmail.com
" Version:     1.0
...
" Split area {{{1
hi StatusLine term=BOLD,reverse cterm=NONE ctermfg=Yellow ctermbg=DarkGray gui=BOLD guibg=#DDDFDD guifg=white
hi StatusLineNC gui=NONE guibg=#DDDFDD guifg=#F9F5F9
hi! link VertSplit StatusLineNC
hi WildMenu gui=UNDERLINE guifg=#DDDFDD guibg=#F9F5F9
...
hi NonText      gui=BOLD guifg=#4000ff guibg=#F9F5F9
...
" Syntax group {{{1
hi Comment term=BOLD ctermfg=darkgray gui=BOLD guifg=darkcyan
