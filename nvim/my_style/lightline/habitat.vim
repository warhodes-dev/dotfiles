" =============================================================================
" Filename: autoload/lightline/colorscheme/habitat.vim
" Author: wrhodes2
" License: MIT License
" Last Change: 2022/06/16 18:32:21.
" =============================================================================
...
let s:p.visual.left = [ [ s:base00, s:magenta ], [ s:base3, s:base01 ] ]
...
let g:lightline#colorscheme#habitat#palette = lightline#colorscheme#fill(s:p)
